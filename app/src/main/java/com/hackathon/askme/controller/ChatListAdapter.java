...
public class ChatListAdapter extends ArrayAdapter<Message> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            holder.textLeft = (TextView)convertView.findViewById(R.id.ivProfileLeft);
            holder.textRight = (TextView)convertView.findViewById(R.id.ivProfileRight);
...
//        final TextView profileView = isMe ? holder.textRight : holder.textLeft;
